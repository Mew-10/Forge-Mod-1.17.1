package net.benjamin.forgemod.block;

import net.benjamin.forgemod.ForgeMod;
import net.benjamin.forgemod.block.custom.ModFlammableRotatedPillarBlock;
import net.benjamin.forgemod.block.custom.SpeedyBlock;
import net.benjamin.forgemod.block.custom.TestBlock;
import net.benjamin.forgemod.block.custom.TomatoPlantBlock;
import net.benjamin.forgemod.item.ModCreativeModeTab;
import net.benjamin.forgemod.item.ModItems;
import net.benjamin.forgemod.world.features.tree.RedwoodTreeGrower;
...
public class ModBlocks {
    ...
    public static final RegistryObject<Block> TITANIUM_BLOCK = registerBlock("titanium_block",
            ...
            "tooltip.block.forgemod.titanium_block");
    ...
    private static <T extends Block> void registerBlockItem(String name, RegistryObject<T> block, String tooltipKey) {
        ModItems.ITEMS.register(name, () -> new BlockItem(block.get(),
                new Item.Properties().tab(ModCreativeModeTab.MY_TAB)) {
            @Override
