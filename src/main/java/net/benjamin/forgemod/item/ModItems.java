...
import net.benjamin.forgemod.block.ModBlocks;
import net.benjamin.forgemod.item.custom.CoalCokeItem;
import net.benjamin.forgemod.item.custom.SmartBlowtorchItem;
...
public class ModItems {
    ...
    public static final RegistryObject<Item> SMART_BLOW_TORCH = ITEMS.register("smart_blow_torch",
            () -> new SmartBlowtorchItem(new Item.Properties().tab(ModCreativeModeTab.MY_TAB).durability(64)));

    public static final RegistryObject<Item> COAL_COKE = ITEMS.register("coal_coke",
            () -> new CoalCokeItem(new Item.Properties().tab(ModCreativeModeTab.MY_TAB)));
