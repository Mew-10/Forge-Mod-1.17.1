package net.benjamin.forgemod.item.custom;
...
public class SmartBlowtorchItem extends Item {
    ...
    public void appendHoverText(ItemStack pStack, @Nullable Level pLevel,
        ...
        if(Screen.hasShiftDown()) {
            pTooltipComponents.add(new TranslatableComponent("tooltip.forgemodd.blowtorch"));
            if(pStack.hasTag()) {
                pTooltipComponents.add(new TextComponent("Charge: " + pStack.getTag().getInt("charge")));
            }
        } else {
            pTooltipComponents.add(new TranslatableComponent("tooltip.forgemodd.blowtorch_shift"));
        }
